...
//
//
// $Id: bmPrimaryGeneratorMessenger.hh,v 1.4 2011-09-28 01:29:04 mmendenhall Exp $
// GEANT4 tag $Name:  $
//
// 
...
class bmPrimaryGeneratorAction;

/// messenger UI for primary event generator
class bmPrimaryGeneratorMessenger: public G4UImessenger {
public:
	/// constructor
    bmPrimaryGeneratorMessenger(bmPrimaryGeneratorAction*);
	/// destructor
	~bmPrimaryGeneratorMessenger();
    
	/// receive command
    void SetNewValue(G4UIcommand*, G4String);
    
private:
    bmPrimaryGeneratorAction* bmAction;				//< primary generator action being controlled
