#ifndef SiliconDetectorConstruction_HH
#define SiliconDetectorConstruction_HH

#include "DetectorConstructionUtils.hh"

/// model for circular silicon detector surrounded by holder, possibly with backing
class SiliconDetectorConstruction: public MaterialUser {
public:
	/// constructor
	SiliconDetectorConstruction(): fDetThick(1.*mm), fDetRadius(5.*mm), pDetMat(Si),
