...
public:
	/// constructor
	WirechamberConstruction(): fWindowThick(6*um), mwpc_entrance_R(7.0*cm), mwpc_exit_R(7.5*cm),
	...
	WireVolumeConstruction activeRegion;	//< active gas region with wireplanes
