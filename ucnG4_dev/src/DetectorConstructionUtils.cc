...
G4Material* MaterialUser::Delrin = NULL;
...
MaterialUser::MaterialUser() {
	...
	Delrin = new G4Material("Delrin", 1.425*g/cm3, 3);
	Delrin->AddElement(G4Element::GetElement("C"),nAtoms=1);
	Delrin->AddElement(G4Element::GetElement("H"),nAtoms=2);
	Delrin->AddElement(G4Element::GetElement("O"),nAtoms=1);
