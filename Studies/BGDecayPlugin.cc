#include "BGDecayPlugin.hh"

BGDecayPlugin::BGDecayPlugin(OctetAnalyzer* OA): OctetAnalyzerPlugin(OA,"bgdecay") {
...
void BGDecayPlugin::fillCoreHists(ProcessedDataScanner& PDS, double weight) {
	Side s = PDS.fSide;
