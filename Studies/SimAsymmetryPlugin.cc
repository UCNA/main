...
SimAsymmetryPlugin::SimAsymmetryPlugin(OctetAnalyzer* OA): OctetAnalyzerPlugin(OA,"simasymmetry") {
...
void SimAsymmetryPlugin::makeSimTree() {
        SimFile = new TFile("SimAnalyzedData.root","RECREATE"); 
...
void SimAsymmetryPlugin::fillSimTree(ProcessedDataScanner& PDS, double weight) {
...
std::vector<TH1*> SimAsymmetryPlugin::calculateCorrections(AsymmetryPlugin& Adat, AsymmetryPlugin& Asim) {
	// unmodified asymmetry
