...
float_err kuriePlotter(TH1F* spectrum, float endpoint, TGraphErrors** tgout = NULL, float targetEP = neutronBetaEp, float fitStart = 250, float fitEnd = 700);

/// iterate Kurie plot until convergence is reached
float_err kurieIterator(TH1F* spectrum, float iguess, TGraphErrors** tgout = NULL, float targetEP = neutronBetaEp,
