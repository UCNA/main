...
std::vector<TSpectrumPeak> tspectrumSearch(TH1* hin, float sigma = 2.0, float thresh = 0.01);
...
MultiGaus multiPeakFitter(TH1* indat, const std::vector<SpectrumPeak>& expectedPeaks, float nSigma = 1.5);
